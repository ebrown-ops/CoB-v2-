        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li><Link href="/software" className="text-base text-gray-300 hover:text-white">Software</Link></li>
              <li><Link href="/loans" className="text-base text-gray-300 hover:text-white">Loans</Link></li>
              <li><Link href="/credit-cards" className="text-base text-gray-300 hover:text-white">Credit Cards</Link></li>
              <li><Link href="/hr-solutions" className="text-base text-gray-300 hover:text-white">HR Solutions</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><Link href="/api/sitemap" className="text-base text-gray-300 hover:text-white">Sitemap</Link></li>
            </ul>
          </div>
        </div>
        <div className="mt-8 border-t border-gray-700 pt-8 flex justify-between items-center">
          <p className="text-base text-gray-400">&copy; 2023 SMB Solutions. All rights reserved.</p>
